...
def home(request):
    ...
    #return render(request, 'home.html', {'name':'David Londoño Palacio'})
    ...
    return render(request, 'home.html', {'searchTerm':searchTerm, 'movies':movies, 'name':'David Londoño Palacio'})
